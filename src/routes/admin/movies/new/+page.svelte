...
<svelte:head><title>New Movie — Admin</title></svelte:head>
...
<div class="max-w-2xl space-y-6">
	<div class="flex items-center gap-3">
		...
		<div>
			<h1 class="text-2xl font-bold text-foreground">New Movie</h1>
			<p class="text-muted-foreground text-sm mt-0.5">Add a new movie to the platform</p>
		</div>
	</div>
	...
	>
		<div class="grid grid-cols-1 md:grid-cols-2 gap-4">
			<div class="md:col-span-2">
				...
				<Input id="name" name="name" required placeholder="Movie title" />
			</div>
			...
			<div class="md:col-span-2">
				...
				<div class="flex flex-wrap gap-2">
					...
					{#if data.genres.length === 0}
						<p class="text-xs text-muted-foreground">No genres yet — <a href="/admin/genres" class="text-primary hover:underline">add some first</a></p>
					{/if}
				</div>
			</div>
